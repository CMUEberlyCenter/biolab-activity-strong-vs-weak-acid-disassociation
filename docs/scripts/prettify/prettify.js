...
(function() {
 function L(a) {
function m(a) {
 var f=a.charCodeAt(0); if (f!==92) return f; var b=a.charAt(1); return (f=r[b])?f:b>="0"&&b<="7"?parseInt(a.substring(1),8):b==="u"||b==="x"?parseInt(a.substring(2),16):a.charCodeAt(1)
} function e(a) {
...
}b.sort((a,f) => a[0]-f[0]||f[1]-a[1]); f=[]; j=[NaN,NaN]; for (c=0; c<b.length; ++c)i=b[c],i[0]<=j[1]+1?j[1]=Math.max(j[1],i[1]):f.push(j=i); b=["["]; o&&b.push("^"); b.push.apply(b,a); for (c=0; c<
f.length; ++c)i=f[c],b.push(e(i[0])),i[1]>i[0]&&(i[1]+1>i[0]&&b.push("-"),b.push(e(i[1]))); b.push("]"); return b.join("")
} function y(a) {
for (var f=a.source.match(/\[(?:[^\\\]]|\\[\S\s])*]|\\u[\dA-Fa-f]{4}|\\x[\dA-Fa-f]{2}|\\\d+|\\[^\dux]|\(\?[!:=]|[()^]|[^()[\\^]+/g),b=f.length,d=[],c=0,i=0; c<b; ++c) {
var j=f[c]; j==="("?++i:j.charAt(0)==="\\"&&(j=Number(j.substring(1)))&&j<=i&&(d[j]=-1)
} for (c=1; c<d.length; ++c)d[c]===-1&&(d[c]=++t); for (i=c=0; c<b; ++c)j=f[c],j==="("?(++i,d[i]===void 0&&(f[c]="(?:")):j.charAt(0)==="\\"&&
(j=Number(j.substring(1)))&&j<=i&&(f[c]=`\\${d[i]}`); for (i=c=0; c<b; ++c)f[c]==="^"&&f[c+1]!=="^"&&(f[c]=""); if (a.ignoreCase&&s) for (c=0; c<b; ++c)j=f[c],a=j.charAt(0),j.length>=2&&a==="["?f[c]=h(j):a!=="\\"&&(f[c]=j.replace(/[A-Za-z]/g,(a) => {
...
{"b": 8,"t": 9,"n": 10,"v": 11,"f": 12,"r": 13},n=[],p=0,d=a.length; p<d; ++p) {
 g=a[p]; if (g.global||g.multiline) throw Error(String(g)); n.push(`(?:${y(g)})`)
...
t=[],
s=0,
l; a.currentStyle?l=a.currentStyle.whiteSpace:window.getComputedStyle&&(l=document.defaultView.getComputedStyle(a,q).getPropertyValue("white-space")); var p=l&&l.substring(0,3)==="pre"; m(a); return {"a": h.join("").replace(/\n$/,""),"c": t}
} function B(a,m,e,h) {
...
} if ((c=b.length>=5&&b.substring(0,5)==="lang-")&&!(o&&typeof o[1]==="string"))c=!1,b="src"; c||(r[f]=b)
}i=d; d+=f.length; if (c) {
...
l=[],p={},d=0,g=e.length; d<g; ++d) {
 var r=e[d],
n=r[3]; if (n) for (var k=n.length; --k>=0;)h[n.charAt(k)]=r; r=r[1]; n=String(r); p.hasOwnProperty(n)||(l.push(r),p[n]=q)
}l.push(/[\S\s]/); y=L(l)
}()); var t=m.length; return e
} function u(a) {
 var m=[],
e=[]; a.tripleQuotedStrings?m.push(["str",/^(?:'''(?:[^'\\]|\\[\S\s]|''?(?=[^']))*(?:'''|$)|"""(?:[^"\\]|\\[\S\s]|""?(?=[^"]))*(?:"""|$)|'(?:[^'\\]|\\[\S\s])*(?:'|$)|"(?:[^"\\]|\\[\S\s])*(?:"|$))/,q,"'\""]):a.multiLineStrings?m.push([
"str",/^(?:'(?:[^'\\]|\\[\S\s])*(?:'|$)|"(?:[^"\\]|\\[\S\s])*(?:"|$)|`(?:[^\\`]|\\[\S\s])*(?:`|$))/,
q,"'\"`"
...
function e(a) {
 switch (a.nodeType) {
case 1: if (k.test(a.className)) break; if (a.nodeName==="BR")h(a),
a.parentNode&&a.parentNode.removeChild(a); else for (a=a.firstChild; a; a=a.nextSibling)e(a); break; case 3: case 4: if (p) {
var b=a.nodeValue,
d=b.match(t); if (d) {
...
t=/\r\n?|\n/,
s=a.ownerDocument,
l; a.currentStyle?l=a.currentStyle.whiteSpace:window.getComputedStyle&&(l=s.defaultView.getComputedStyle(a,q).getPropertyValue("white-space")); var p=l&&l.substring(0,3)==="pre"; for (l=s.createElement("LI"); a.firstChild;)l.appendChild(a.firstChild); for (var d=[l],g=0; g<d.length; ++g)e(d[g]); m===(m|0)&&d[0].setAttribute("value",
...
d=a.e,
g=d.length,
a=0; d[g]=s; var n,r; for (n=r=0; n<g;)d[n]!==d[n+2]?(d[r++]=d[n++],d[r++]=d[n++]):n+=2; g=r; for (n=r=0; n<g;) {
...
I}`,J,v
],"hashComments": !0,"cStyleComments": !0,"multiLineStrings": !0,"regexLiterals": !0}),
...
]),["in.tag"]); k(x([],[["atv",/^[\S\s]+/]]),["uq.val"]); k(u({"keywords": F,"hashComments": !0,"cStyleComments": !0,"types": K}),["c","cc","cpp","cxx","cyc","m"]); k(u({"keywords": "null,true,false"}),["json"]); k(u({"keywords": H,"hashComments": !0,"cStyleComments": !0,"verbatimStrings": !0,"types": K}),["cs"]); k(u({"keywords": G,"cStyleComments": !0}),["java"]); k(u({"keywords": v,"hashComments": !0,"multiLineStrings": !0}),["bsh","csh","sh"]); k(u({"keywords": I,"hashComments": !0,"multiLineStrings": !0,"tripleQuotedStrings": !0}),
...
f,b; if (b=
!k) {
b=n; for (var o=void 0,c=b.firstChild; c; c=c.nextSibling) var i=c.nodeType,o=i===1?o?b:c:i===3?N.test(c.nodeValue)?b:o:o; b=(f=o===b?void 0:o)&&f.tagName==="CODE"
 ...
 b=!0; break
}b||((b=(b=n.className.match(/\blinenums\b(?::(\d+))?/))?b[1]&&b[1].length?Number(b[1]):!0:!1)&&D(n,b),d={"g": k,"h": n,"i": b},E(d))
}
